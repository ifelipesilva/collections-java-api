...
public class CatalogoLivros {
    ...
    public static void main(String[] args) {
        ...
        catalogoLivros.adicionarLivro("Livro 1", "Autor 1", 1956);
        catalogoLivros.adicionarLivro("Livro 2", "Autor 2", 1946);
        catalogoLivros.adicionarLivro("Livro 1", "Autor 1", 1956);
        catalogoLivros.adicionarLivro("Livro 4", "Autor 4", 2956);


        System.out.println(catalogoLivros.pesquisarPorAutor("Autor 1"));
        System.out.println(catalogoLivros.pesquisarPorIntervaloAnos(2020, 3422));
